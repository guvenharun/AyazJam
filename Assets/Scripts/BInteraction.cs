...
public class Interaction : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Interactable") || other.CompareTag("Usable"))
        {
            ...
            if (interactionMessage != null)
            {
                interactionMessage.text = "F tuşuna bas"; // Etkileşim mesajı
                interactionMessage.gameObject.SetActive(true);
            }
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject == currentInteractableObject)
        {
            ...
            if (interactionMessage != null)
            {
                interactionMessage.gameObject.SetActive(false); // Mesajı gizle
            }
        }
    }
        ...
        if (currentInteractableObject != null)
        {
            if (currentInteractableObject.CompareTag("Interactable"))
            {
                if (interactionImage != null)
                {
                    ...
                    if (iconComponent != null && iconComponent.icon != null)
                    {
                        interactionImage.sprite = iconComponent.icon;
                ...
                currentInteractableObject.SetActive(false); // Nesneyi yok etmek yerine devre dışı bırak
            }
